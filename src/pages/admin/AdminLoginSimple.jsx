...
const AdminLoginSimple = () => {
  ...
  const handleLogin = async (e) => {
    ...
    console.log("AdminLoginSimple: Attempting login with email:", email);
    console.log("AdminLoginSimple: Attempting login with password:", password);

    const { data, error } = await signIn(email, password);

    console.log("AdminLoginSimple: Supabase signIn response data:", data);
    console.log("AdminLoginSimple: Supabase signIn response error:", error);
        ...
        <div className="glass-effect border-blue-500/50 text-slate-100 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <h1 className="text-3xl font-bold gradient-text">Simple Admin Login</h1>
            </div>
            <p className="text-slate-400">Direct Supabase Authentication.</p>
          </div>
