  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.title || !formData.description) {
      toast({
        ...
        description: "Por favor completa el título y descripción de la vacante.",
        variant: "destructive"
      });
      return;
    }
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
            ...
            <h2 className="text-3xl font-bold gradient-text mb-6">Crear Nueva Vacante</h2>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-slate-300">Título del puesto *</label>
                  <input
                    type="text"
                    name="title"
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-slate-300">Ubicación</label>
                  <input
                    type="text"
                    name="location"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2 text-slate-300">Tipo de contrato</label>
                  <select
                    name="type"
                    value={formData.type}
                    onChange={handleChange}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 text-slate-300">Rango salarial</label>
                  <input
                    type="text"
                    name="salary"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-slate-300">Descripción *</label>
                <textarea
                  name="description"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-slate-300">Requisitos</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-slate-300">Preguntas para la IA</label>
